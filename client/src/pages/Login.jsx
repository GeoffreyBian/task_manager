          ...
          <div className='w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center'>
            <form onSubmit={handleSubmit(submitHandler)} className='"form-container w-full md:w-[400px] flex flex-col gap-y-8 bg-white px-10 pt-14 pb-14'>
              <div className=''>
                ...
                <p className='text-center text-base text-gray-700'>Keep safe</p>
              ...
              <div className='flex flex-col gap-y-5'>
                ...
                <Textbox
                  ...
                  label='Password'
                  className="w-full rounded-full"
                  register={register("email", { required: "Password required" })}
                  error={errors.email ? errors.email.message : ""}
                />
                <span className='text-sm text-gray-500 hover:text-blue-600 hoverLunderline cursor-pointer'>
                  Forget Password?
                </span>
                <Button
                type="submit"
